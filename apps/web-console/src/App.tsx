...
type CodexThread = { threadId: string; projectPath: string; title: string | null; status: string; lastEventAt: string; lastMessage?: string | null };
