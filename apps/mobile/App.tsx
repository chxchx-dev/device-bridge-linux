...
import { BridgeClient, type Action, type DeviceStatus, type IntegrationStatus, type Mode, type ModeStatus } from './src/api/bridge-client';
...
export default function App() {
  ...
  const forget = async () => { await clearSession(); setSession(undefined); setStatus(undefined); setActions([]); setModeStatus(undefined); setMessage('Session removed from secure storage.'); };
