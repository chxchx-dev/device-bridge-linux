...
export default function App() {
  ...
  const pair = async () => {
    ...
    try { const next = await client.pair(DEVICE_ID, pairingToken); await saveSession(next); setSession(next); setPairingToken(''); await refresh(next); }
