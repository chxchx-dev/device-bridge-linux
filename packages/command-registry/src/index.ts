...
export const actionRegistry: Readonly<Record<ActionId, ActionDefinition>> = {
  ...
  'system.session.rotate': { id: 'system.session.rotate', risk: 'R2', capability: 'system:read', enabledByDefault: true, confirmation: 'step-up', description: 'Rotate this device session token' },
  ...
  'mode.preview': { id: 'mode.preview', risk: 'R0', capability: 'mode:read', enabledByDefault: true, confirmation: 'none', description: 'Preview the declared mode transition' },
  ...
  'services.status': { id: 'services.status', risk: 'R0', capability: 'system:read', enabledByDefault: true, confirmation: 'none', description: 'Read registered Fedora service status' },
  ...
  'codex.projects.list': { id: 'codex.projects.list', risk: 'R0', capability: 'codex:read', enabledByDefault: false, confirmation: 'none', description: 'List registered Codex projects' },
  ...
  'codex.events.list': { id: 'codex.events.list', risk: 'R0', capability: 'codex:read', enabledByDefault: false, confirmation: 'none', description: 'List bounded Codex task events' },
