...
test('Codex thread store persists only bounded metadata and updates lifecycle state', () => {
  ...
  assert.deepEqual(store.get('thread-1'), { threadId: 'thread-1', projectPath: '/workspace/project', title: 'Phase 06', status: 'running', lastEventAt: '2026-08-11T00:01:00.000Z', createdAt: '2026-08-11T00:00:00.000Z' });
